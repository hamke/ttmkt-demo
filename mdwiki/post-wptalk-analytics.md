# [워드프레스] 마음에 드는 웹사이트/쇼핑몰에 설치된 테마 및 플러그인 간편 자동 확인 방법 - 워드프레스톡

<!-- ---
title: "[워드프레스] 마음에 드는 웹사이트/쇼핑몰에 설치된 테마 및 플러그인 간편 자동 확인 방법 - 워드프레스톡"
description: 워드프레스 애널리틱스(WordPress Analytics, 온라인 자동 분석 툴)로 원하는 사이트의 워드프레스 여부 및 설치된 테마와 플러그인 분석 정보를 간편하게 확인할 수 있습니다.
...
먼저 확인하고자 웹사이트 또는 쇼핑몰의 URL(웹주소)를 입력란에 기입합니다.
...
분석 결과가 사이트의 모든 정보를 대변할 수는 없습니다.
