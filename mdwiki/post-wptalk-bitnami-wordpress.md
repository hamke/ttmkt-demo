# [꿀팁] 워드프레스 내 컴퓨터(로컬 웹서버)에 간편하게 설치하는 방법 : 비트나미(Bitnami) - 워드프레스톡
...
- [...](#index-00)
- [1. 비트나미(Bitnami) 워드프레스 인스톨러](#index-01)
- [...](#index-02)
- [...](#index-03)
- [맺음말](#index-epilogue)
...
## 1. 비트나미(Bitnami) 워드프레스 인스톨러

<center><a href="https://www.wp-talk.com/kakao/" target="_blank"_><img src="https://hellotblog.files.wordpress.com/2019/09/wptalk-bitnami-wordpress-install-800x480.png" style="max-width:100%;" alt="워드프레스톡(WP-TALK.COM)"></a></center>



***

[참고] <a href="https://bitnami.com/stack/wordpress/installer" target="_blank"_>비트나미(Bitnami) 워드프레스 인스톨러</a>
