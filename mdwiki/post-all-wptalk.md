...
***
(미발표) <a href="https://demo.ttmkt.com/mdwiki/#!post-wptalk-analytics.md" target="_blank" rel="noopener noreferrer"_>[워드프레스] 마음에 드는 웹사이트/쇼핑몰에 설치된 테마 및 플러그인 간편 자동 확인 방법</a>
...
[참고] <a href="https://www.wp-talk.com/kr/analytics-usage/" target="_blank"_>**마음에 드는 웹사이트/쇼핑몰에 설치된 워드프레스 테마 및 플러그인 간편 자동 분석 방법 - 워드프레스톡 매거진**</a>
...
[참고] <a href="https://news.codetalk.kr/wordpress-login-custom-logo-codetalk/" target="_blank" rel="noopener noreferrer"_>워드프레스 로그인 페이지의 WP 로고를 내 브랜드 로고로 변경하는 방법 - 코드톡 매거진</a>

[참고] <a href="https://news.trendtalk.kr/wordpress-database-connection-error/" target="_blank" rel="noopener noreferrer"_>워드프레스(WP)에서 데이터베이스 에러 발생시 체크리스트 및 해결 방법 - 트렌드톡 매거진</a>
