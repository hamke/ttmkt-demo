...
[참고] <a href="https://www.wp-talk.com/kr/basic/" target="_blank"_>**워드프레스(WordPress)란? 시작하기 가이드 및 사용법 총정리 (웹사이트/블로그/쇼핑몰 제작/개발 방법, 호스팅/테마/플러그인 다운로드/설치 매뉴얼, 장점/단점 등) - 워드프레스웹코리아**</a>
