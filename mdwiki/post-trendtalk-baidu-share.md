# 바이두 쉐어(Baidu Share) 기능을 중국 웹사이트/쇼핑몰에 설치해야 하는 이유 - 트렌드톡 매거진

<!-- <a name="index"></a> -->
***
## ◼︎ 목차 <span style="font-size:0.5em; float:right; padding:0.5em 0 0;"><i class="fas fa-clock"></i> 업데이트 : <span class="post-year"></span>-<span class="post-month-digits"></span>-01</span>

- [바이두 쉐어(Baidu Share)란?](#index-00)
- [바이두 쉐어 설치해야 하는 이유](#index-01)
- [바이두 쉐어 설치하는 방법](#index-02)
- [맺음말](#index-epilogue)
- [도움이 될 만한 연관 추천 글](#recommendation)

<!-- <a name="index-00"></a> -->
***
## ◼︎ 바이두 쉐어(Baidu Share)란?

<a href="https://news.trendtalk.kr/" target="_blank" rel="noopener noreferrer"_>![](https://hellotblog.files.wordpress.com/2019/04/baidu-share-cover-800x420.png)</a>

바이두 쉐어(百度分享, Baidu Share)는 바이두가 제공하는 소셜 미디어 기능입니다.
